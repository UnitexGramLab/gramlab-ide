...
public class LocateCommand extends CommandBuilder {
	...
	public LocateCommand maxExplorationSteps() {
		element("--locate_argument=--stack_max=" + Preferences.getMaxExplorationSteps());
		return this;
	}
	
	public LocateCommand maxMatchesPerSubgraph() {
		element("--locate_argument=--max_matches_per_subgraph=" + Preferences.getMaxMatchesPerSubgraph());
		return this;
	}
	
	public LocateCommand maxMatchesPerToken() {
		element("--locate_argument=--max_matches_at_token_pos=" + Preferences.getMaxMatchesPerToken());
		return this;
	}
