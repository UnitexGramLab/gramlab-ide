...
public abstract class CommandBuilder implements AbstractCommand {
	...
	public String getCassysOptionMatches() {
		...
		String stack = " --locate_argument=--stack_max=" + Preferences.getMaxExplorationSteps();
		String subgraph = " --locate_argument=--max_matches_per_subgraph=" + Preferences.getMaxMatchesPerSubgraph();
		String token = " --locate_argument=--max_matches_at_token_pos=" + Preferences.getMaxMatchesPerToken();
