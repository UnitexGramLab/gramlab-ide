...
public class GraphBox extends GenericGraphBox {
  ...
  public void setContent(String s) {
    ...
    try {
      ...
      JOptionPane.showMessageDialog(null, "BackSlashAtEndOfLineException", "Error", JOptionPane.ERROR_MESSAGE);
    } catch (final MissingGraphNameException e) {
      JOptionPane.showMessageDialog(null, "MissingGraphNameException", "Error", JOptionPane.ERROR_MESSAGE);
    } catch (final NoClosingQuoteException e) {
      JOptionPane.showMessageDialog(null, "NoClosingQuoteException", "Error", JOptionPane.ERROR_MESSAGE);
    } catch (final NoClosingRoundBracketException e) {
      JOptionPane.showMessageDialog(null, "NoClosingRoundBracketException", "Error", JOptionPane.ERROR_MESSAGE);
    } catch (final NoClosingSupException e) {
      JOptionPane.showMessageDialog(null, "NoClosingSupException", "Error", JOptionPane.ERROR_MESSAGE);
    }
    if (!tmp.equals("<E>")) {
      // dimensions of a full box
      Width = maxLineWidth() + 10;
