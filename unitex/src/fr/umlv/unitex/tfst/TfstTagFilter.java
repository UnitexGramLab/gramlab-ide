...
public class TfstTagFilter {
    ...
    public TfstTagFilter(boolean keepSurface, boolean keepLemma, boolean allExceptInfClasses, String directListing, String tagLetterNumber, String tagPrefixString) {
