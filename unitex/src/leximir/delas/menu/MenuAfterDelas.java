 ...
 * @author rojo
 */
public class MenuAfterDelas extends javax.swing.JFrame {
     ...
     */
    public MenuAfterDelas() {
        initComponents();
    }

    public MenuAfterDelas(EditorDelas aThis, Object[] obj,int id) {
        initComponents();
        this.editor=aThis;
        this.obj=obj;
        idObject = id;
    ...
    private void jButtonOkActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonOkActionPerformed
        ...
        editor.getTableModel().insertRow(idObject+1,newValue);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MenuAfterDelas.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        //</editor-fold>
        //</editor-fold>
        //</editor-fold>
        ...
        /* Create and display the form */
         java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new MenuAfterDelas().setVisible(true);
            }
        });
    }
