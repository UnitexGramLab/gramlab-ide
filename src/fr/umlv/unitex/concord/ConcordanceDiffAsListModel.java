...
public class ConcordanceDiffAsListModel extends ConcordanceAsListModel {
	...
	public Object getElementAt(int i) {
		...
		int start=interval.getStartInBytes()+55; // we don't want neither the <tr><td nowrap bgcolor="#90EE90"><font color="#008000">
		int end=interval.getEndInBytes()-19;     // nor the </font></td></tr>
	...
	static class DiffLine {
		...
		static DiffLine buildDiffLine(String line) {
			DiffLine result=new DiffLine(null,null,null,null);
