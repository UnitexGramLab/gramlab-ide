...
public class ProcessInfoFrame extends JInternalFrame {
     ...
     *
     * @param c             array containing the shell commands to run
     * @param close         indicates if the frame must be closed after the completion of
     *                      all commands
     * @param myDo          object describing actions to do after the completion of all
     *                      commands
     * @param stopIfProblem indicates if the failure of a command must stop all commands
     */
