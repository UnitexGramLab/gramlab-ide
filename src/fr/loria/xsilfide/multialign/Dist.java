...
//   }
    ...
    */
    ...
    public static int TwoSideDistance(int x1, int y1, int x2, int y2) {
        final int penalty21 = 230; /* 23 : -100 * ln([prob of 2-1 match] / [prob of 1-1 match]) */
        final int penalty22 = 440; /* 44 : -100 * ln([prob of 2-2 match] / [prob of 1-1 match]) */
        final int penalty01 = 450; /* 45 : -100 * ln([prob of 0-1 match] / [prob of 1-1 match]) */
